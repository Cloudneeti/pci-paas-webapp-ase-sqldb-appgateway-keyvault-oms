...
$SQLBackupName = "ContosoPayments.bacpac" ##$$BUG$$ Remove --- Where is this? we need it on GIT for review.....

$StorageUri = "http://$StorageName.blob.core.windows.net/$SQLContainerName/$SQLBackupName" ##$$BUG$$ I will find a place to host that is not anonymous. can we put this on git?
$cmkName = "CMK1" 
$cekName = "CEK1" 
$keyName = "CMK1" 
$location = 'East US'
...
$unqiueid = Get-Random -Maximum 999 ##$$BUG$$ ## use this less chance of collision ((Get-Date).ToUniversalTime()).ToString('MMdd-HH'
